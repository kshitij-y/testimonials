...
export default function Page() {
  ...
  return (
    <div className="bg-gray-900 w-full min-h-screen h-screen flex">
      ...
      {space && (
        <div className="flex flex-col text-gray-300 bg-gray-800 min-w-[300px] w-[400px]   h-fit rounded-lg py-8 px-6 my-auto ml-12">
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3 mt-6 p-2 overflow-auto scrollbar-hide my-12">
